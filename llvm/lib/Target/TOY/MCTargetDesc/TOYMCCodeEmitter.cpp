//===-- TOY/TOYMCCodeEmitter.cpp - Convert TOY code to machine code -------===//
//
...
class TOYMCCodeEmitter : public MCCodeEmitter {
  TOYMCCodeEmitter(const TOYMCCodeEmitter &) = delete;
  void operator=(const TOYMCCodeEmitter &) = delete;
...
unsigned TOYMCCodeEmitter::getMachineOpValue(const MCInst &MI,
  ...
  case MCSymbolRefExpr::VK_TOY_LO: {
    FixupKind = TOY::fixup_toy_mov_lo16_pcrel;
    break;
  }
  case MCSymbolRefExpr::VK_TOY_HI: {
    FixupKind = TOY::fixup_toy_mov_hi16_pcrel;
    break;
  }
  }
...
unsigned TOYMCCodeEmitter::getMemSrcValue(const MCInst &MI, unsigned OpIdx,
                                          SmallVectorImpl<MCFixup> &Fixups,
                                          const MCSubtargetInfo &STI) const {
  unsigned Bits = 0;
